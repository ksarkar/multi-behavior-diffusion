...
<experiments>
  ...
  <experiment name="seed-size-vs-utilization-n-sw-c-threshold-average" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>utilization</metric>
  ...
  <experiment name="deg-res-seed-size-vs-utilization-threshold-average-n-sw-cost" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <metric>utilization</metric>
